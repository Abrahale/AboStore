...
export const getState: MemoizedSelector<object, State> = createFeatureSelector<State>(storeConstants.DEPARTMENT);
...
export const selectDepartmentError: MemoizedSelector<object, any> =
